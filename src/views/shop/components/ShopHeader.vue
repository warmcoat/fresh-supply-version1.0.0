...
import { IShopDetail, IDiscount, IDiscountContent } from '@/types'
...
<template>
	<div class="shop-header">
		...
		<div class="shop-header__service">
			<div v-for="v in topThreeServices" :key="v.label" class="services">
		...
		<div class="content">
			...
			<div v-for="v in reduction" :key="`${v.if}_${v.count}`" class="red-bag">
				...
				<div class="m flex">
					...
					<div class="detail">满￥{{ v.if }}可用2022.01.12到期</div>
				</div>
			...
			.menbership {
				...
				.r {
					...
					.receive {
						...
						width: 150px;
						height: 50px;
						background: linear-gradient(to right, rgb(253, 113, 78));
						color: white;
						border-radius: 30px;
					}
					.open {
						...
						width: 150px;
						height: 50px;
						background: linear-gradient(to right, rgb(241, 216, 191));
						color: rgb(86, 42, 31);
						border-radius: 30px;
					}
				}
